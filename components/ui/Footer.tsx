...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center w-full mx-auto lg:max-w-screen-md">
      <hr className="w-full mb-8 border-gray-800 border-1" />
      ...
      <AnimationContainer customClassName="w-full grid place-items-center grid-cols-3 gap-1 lg:gap-4 pb-8 sm:grid-cols-3 mx-3">
        <div className="flex flex-col space-y-4">
          <Link
            href="/"
            className="flex items-center gap-2 text-gray-500 transition hover:text-gray-600 ease"
          >
            <svg
        ...
        <div className="flex flex-col space-y-4">
          <ExternalLink href="https://github.com/vierynugroho">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <ExternalLink href="https://www.linkedin.com/in/viery-nugroho/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
